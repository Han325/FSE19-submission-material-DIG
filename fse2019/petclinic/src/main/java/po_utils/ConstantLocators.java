...
public enum ConstantLocators {
    ...
    OWNER_INFO_PAGE (By.xpath("//a[normalize-space()='Edit Owner']")),
    OWNER_INFO_PAGE_SECOND_TABLE (By.xpath("//h2[normalize-space()='Pets and Visits']/following-sibling::table[1]/tbody/tr")),
